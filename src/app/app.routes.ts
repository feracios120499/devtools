...
// Routes that embed Monaco editor get a scoped provider so the loader
// stays in their lazy chunk instead of leaking into the shared bundle.
const monacoProviders = [provideMonacoEditor()];
