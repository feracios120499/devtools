...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, PrimeNgModule, PageHeaderComponent],
...
export class Base64ToFileComponent implements OnInit, OnDestroy {
  ...
  private setupSeo() {
    const metaData: MetaData = {
      ...
      OgDescription:
        'Free online Base64 to File converter. Convert Base64 encoded data back to downloadable files with automatic file type detection.',
      description:
        'Free online Base64 to File converter. Convert Base64 encoded data back to files. Download files from Base64 strings with automatic file type detection. Perfect for developers and data processing.',
      keywords: [
        'base64 to file',
        'base64 decoder',
        'base64 converter',
      ...
      jsonLd: {
        ...
        description:
          'Free online tool for converting Base64 encoded data to downloadable files',
